        ...
        child: Stack(
          children: [
            Selector<CurrentState, int>(
                selector: (_, provider) => provider.knobSelected,
                builder: (context, knobSelected, __) {
                  return Container(
                    decoration: BoxDecoration(
                      gradient:
                          colorPalettes[currentState.knobSelected].gradient,
                    ),
                  );
                }),
            Selector<CurrentState, int>(
                ...
                builder: (context, knobSelected, __) {
                  return SvgPicture.asset(
                    colorPalettes[currentState.knobSelected].svgPath,
                    height: size.height,
                    width: size.width,
                    fit: BoxFit.cover,
                  );
